...
uel0301_Rambo_name=""
uel0301_RAS_desc="SACU (RAS Preset)"
...
url0301_RAS_desc="SACU (RAS Preset)"
...
OPTIONS_0009="Display Loading Tips"
...
SCORE_0046="Victory"
SCORE_0047="Defeat"
SCORE_0048="This objective will be revealed only after it's completion"
...
Unit_Description_0090="Provides 7000 energy storage. Construct next to power generators for adjacency bonus. Required to enable ACU Overcharge ability."
...
Unit_Description_0210="Provides 7000 energy storage. Construct next to power generators for adjacency bonus. Required to enable ACU Overcharge ability."
...
Unit_Description_0287="Provides 7000 energy storage. Construct next to power generators for adjacency bonus. Required to enable ACU Overcharge ability."
...
Unit_Description_0428="Increases main cannon damage to 850% and grants Area-Of-Effect damage radius."
...
Unit_Description_0402="Provides 7000 energy storage. Construct next to power generators for adjacency bonus. Required to enable ACU Overcharge ability."
...
_Video="Video"
_Yes="Yes"
_Show_Scenario_Info="Scenario"
_Show_Game_Info="Show Game Info"
_Tech="T"
...
ability_personalstealth="Personal Radar Stealth"
ability_radar="Radar"
...
ability_stealth_sonarfield="Sonar Stealth Field"
ability_stealthfield="Radar Stealth Field"
...
key_binding_0004="Default Preset"
key_binding_0005="Are you sure you want to reset all key bindings to the default (GPG) preset?"
key_binding_0006="The %s key is already mapped under %s category, are you sure you want to clear it for the following action? \n\n %s"
...
key_binding_0010="Toggle Category"
key_binding_0011="Toggle visibility of all actions for this category of keys"
key_binding_0012="Opens a dialog that allows assigning key binding for a given action"
key_binding_0013="Removes currently assigned key binding for a given action"
key_binding_0014="Category Statistics"
key_binding_0015="Show total of bound actions and total of all actions in this category of keys"
key_binding_0016="Clear Filter"
key_binding_0017="Clears text that was typed in the filter field."
key_binding_0018="Key Binding Filter"
key_binding_0019='Filter all actions by typing either:\n - full key binding "CTRL+K"\n - partial key binding "CTRL"\n - full action name "Self-Destruct"\n - partial action name "Self"\n\n Note that collapsing of key categories is disabled while this filter contains some text'
key_binding_0020="Reset all key bindings to the hotbuild (FAF) preset"
key_binding_0021="Closes this dialog and confirms assignments of key bindings"
key_binding_0022="Reset all key bindings to the default (GPG) preset"
key_binding_0023="Filter"
key_binding_0024="Are you sure you want to reset all key bindings to the alternative (FAF) preset? (easier to learn)"
key_binding_0025="Alternative Preset"
key_binding_0026="Reset all key bindings to the alternative (FAF) preset (easier to learn)"
...
key_desc_0141="Run the console command \"ScenarioMethod OnF3\""
key_desc_0142="Run the console command \"ScenarioMethod OnShiftF3\""
key_desc_0143="Run the console command \"ScenarioMethod OnCtrlF3\""
key_desc_0144="Run the console command \"ScenarioMethod OnShiftF4\""
key_desc_0145="Run the console command \"ScenarioMethod OnCtrlF4\""
key_desc_0146="Run the console command \"ScenarioMethod OnCtrlAltF4\""
key_desc_0147="Run the console command \"ScenarioMethod OnF4\""
key_desc_0148="Run the console command \"ScenarioMethod OnF5\""
key_desc_0149="Run the console command \"ScenarioMethod OnShiftF5\""
key_desc_0150="Run the console command \"ScenarioMethod OnCtrlF5\""
key_desc_0151="Run the console command \"ScenarioMethod OnCtrlAltF5\""
...
key_desc_0275="build Upgrades + T3 Mobile Anti Air + T3 Air Transport + T3 torpedo bomber"

-- Extra
key_desc_0276="build {i ueb0101_desc}" --Land Factory HQ
key_desc_0277="build {i ueb0102_desc}" --Air Factory HQ
key_desc_0278="build {i ueb0103_desc}" --Naval Factory HQ
...
key_desc_0379="build T3 Mobile Anti Air"
key_desc_0380="build T2 Support Factory"
key_desc_0381="build T2 Support Land Factory"
key_desc_0382="build T2 Support Air Factory"
key_desc_0383="build T2 Support Naval Factory"
key_desc_0384="build T3 Support Factory"
key_desc_0385="build T3 Support Land Factory"
key_desc_0386="build T3 Support Air Factory"
key_desc_0387="build T3 Support Naval Factory"
key_desc_0388="Toggles the Notify customisation screen"

-- Alternative
key_desc_0389="build factories & quantum gateway + engineers & SCUs"
key_desc_0390="build radars (+ perimeter & eye of Rhianne) + land scouts + air scouts"
key_desc_0391="build shields + mobiles Shields & shield disruptors + shield boat"
key_desc_0392="build tactical missiles defense & strategic missile defense"
key_desc_0393="build experimentals + mobile bomb + guided missile"
key_desc_0394="build sonars + transports + amphibious / hover tanks"
...
lobui_0397="The options included in this map specified invalid defaults. See moholog for details."
lobui_0398="An arbitrary option has been selected for now: check the game options screen!"
...
restricted_units_dlg_0001="Current Restrictions"
restricted_units_dlg_0002="Restrictions are set using Presets (first four rows), Custom restrictions (rest of rows), or combination of both - Presets and Custom restrictions.\n\nTo minimize number of restrictions, first select custom restrictions and then preset restrictions."
restricted_units_dlg_0003="%s Restrictions = %s Custom + %s Presets (%s)"
...
restricted_units_info_BASE="Prevents base structures except factories and economy buildings"
restricted_units_data_BASE="No Base Structures"
restricted_units_info_BOTS="Prevents all Bot units"
restricted_units_data_BOTS="No Bot Units"
restricted_units_info_T1ARTY="Prevents T1 artillery structures"
restricted_units_data_T1ARTY="No T1 Artillery"
restricted_units_info_SNIPES_AIR="Prevents air units capable of sniping ACU from a long range or in a few flybys"
restricted_units_data_SNIPES_AIR="No Air Snipes"
restricted_units_info_SNIPES_LAND="Prevents land units capable of sniping ACU from by detonating bombs in close range"
restricted_units_data_SNIPES_LAND="No Mobile Bombs"
restricted_units_info_SNIPES_BOTS="Prevents land units capable of sniping ACU from a long range"
restricted_units_data_SNIPES_BOTS="No Sniper Bots"
restricted_units_info_SNIPES_BASE="Prevents structures capable of detonating mines in close proximity of enemy units"
restricted_units_data_SNIPES_BASE="No Land Mines"
restricted_units_info_T2_LAND_SPAM="Prevents construction of T2 land units, except engineers"
restricted_units_data_T2_LAND_SPAM="No T2 Land Units"
restricted_units_info_T3_LAND_SPAM="Prevents construction of T3 land units, except engineers and support commanders"
restricted_units_data_T3_LAND_SPAM="No T3 Land Units"
restricted_units_info_T2_AIR_SPAM="Prevents construction of T2 air units, except air scouts and transports"
restricted_units_data_T2_AIR_SPAM="No T2 Air Units"
restricted_units_info_T3_AIR_SPAM="Prevents construction of T3 air units, except air scouts and transports"
restricted_units_data_T3_AIR_SPAM="No T3 Air Units"
restricted_units_info_T2_NAVY_SPAM="Prevents construction of T2 naval units"
restricted_units_data_T2_NAVY_SPAM="No T2 Navy Units"
restricted_units_info_T3_NAVY_SPAM="Prevents construction of T3 naval units"
restricted_units_data_T3_NAVY_SPAM="No T3 Navy Units"
restricted_units_info_T1_BASE_SPAM="Prevents building T1 structures except factories and economy buildings"
restricted_units_data_T1_BASE_SPAM="No T1 Structures"
restricted_units_info_T2_BASE_SPAM="Prevents building T2 structures except factories and economy buildings"
restricted_units_data_T2_BASE_SPAM="No T2 Structures"
restricted_units_info_T3_BASE_SPAM="Prevents building T3 structures except factories and economy buildings"
restricted_units_data_T3_BASE_SPAM="No T3 Structures"
restricted_units_info_ENGINEERS="Prevents all civil engineering units"
restricted_units_data_ENGINEERS="No Civil Engineers"
restricted_units_info_INTEL_SONAR="Prevents naval units and structures that provide intelligence"
restricted_units_data_INTEL_SONAR="No Naval Intel"
restricted_units_info_INTEL_LAND="Prevents land units that provide intelligence"
restricted_units_data_INTEL_LAND="No Mobile Intel"
restricted_units_info_STEALTH_AIR="Prevents all air units that have personal stealth"
restricted_units_data_STEALTH_AIR="No Stealth Aircrafts"
restricted_units_info_STEALTH_BASE="Prevents all structures that provide stealth field for nearby units or structures"
restricted_units_data_STEALTH_BASE="No Stealth Field Structures"
restricted_units_info_STEALTH_LAND="Prevents all mobile land units that have personal stealth or provide stealth field for nearby units or structures"
restricted_units_data_STEALTH_LAND="No Mobile Stealth"
restricted_units_info_STEALTH_NAVY="Prevents all naval units that provide stealth field for nearby units or structures"
restricted_units_data_STEALTH_NAVY="No Stealth Field Boats"
restricted_units_info_ANTIAIR_FIGHTERS="Prevents air units with anti-air weapons: interceptors and air fighters"
restricted_units_data_ANTIAIR_FIGHTERS="No Anti-Air Fighters"
restricted_units_info_ANTIAIR_NAVY="Prevents naval units with anti-air weapons:  cruisers and aircraft carriers"
restricted_units_data_ANTIAIR_NAVY="No Anti-Air Navy"
restricted_units_info_ANTIAIR_LAND="Prevents land units with anti-air weapons"
restricted_units_data_ANTIAIR_LAND="No Anti-Air Land Units"
restricted_units_info_ANTIAIR_BASE="Prevents structures with anti-air weapons"
restricted_units_data_ANTIAIR_BASE="No Anti-Air Structures"
restricted_units_info_TORPEDO_AIR="Prevents air units with torpedo weapons"
restricted_units_data_TORPEDO_AIR="No Torpedo Bombers"
restricted_units_info_TORPEDO_BOATS="Prevents naval units with torpedo weapons"
restricted_units_data_TORPEDO_BOATS="No Torpedo Boats"
restricted_units_info_TORPEDO_LAND="Prevents land units with torpedo weapons"
restricted_units_data_TORPEDO_LAND="No Torpedo Land Units"
restricted_units_info_TORPEDO_BASE="Prevents structures with torpedo weapons"
restricted_units_data_TORPEDO_BASE="No Torpedo Structures"
restricted_units_info_DIRECTFIRE_AIR="Prevents air bombers with direct-fire weapons"
restricted_units_data_DIRECTFIRE_AIR="No Direct-Fire Bombers"
restricted_units_info_DIRECTFIRE_GUNSHIPS="Prevents air gunships with direct-fire weapons"
restricted_units_data_DIRECTFIRE_GUNSHIPS="No Direct-Fire Gunships"
restricted_units_info_DIRECTFIRE_NAVY="Prevents naval units with direct-fire weapons"
restricted_units_data_DIRECTFIRE_NAVY="No Direct-Fire Navy"
restricted_units_info_DIRECTFIRE_LAND="Prevents land units with direct-fire weapons"
restricted_units_data_DIRECTFIRE_LAND="No Direct-Fire Land"
restricted_units_info_DIRECTFIRE_BOTS="Prevents bots with direct-fire weapons"
restricted_units_data_DIRECTFIRE_BOTS="No Direct-Fire Bots"
restricted_units_info_DIRECTFIRE_BASE="Prevents all structures with direct-fire weapons"
restricted_units_data_DIRECTFIRE_BASE="No Point Defenses"
restricted_units_info_DIRECTFIRE_BASE_T1="Prevents T1 structures with direct-fire weapons"
restricted_units_data_DIRECTFIRE_BASE_T1="No T1 Point Defenses"
restricted_units_info_DIRECTFIRE_BASE_T2="Prevents T2 structures with direct-fire weapons"
restricted_units_data_DIRECTFIRE_BASE_T2="No T2 Point Defenses"
restricted_units_info_DIRECTFIRE_BASE_T3="Prevents T3 structures with direct-fire weapons"
restricted_units_data_DIRECTFIRE_BASE_T3="No T3 Point Defenses"
restricted_units_info_SHIELD_AIR="Prevents air units with shield generators"
restricted_units_data_SHIELD_AIR="No Air Shields"
restricted_units_info_SHIELD_BOATS="Prevents naval units with shield generators"
restricted_units_data_SHIELD_BOATS="No Naval Shields"
restricted_units_info_SHIELD_LAND="Prevents land units with shield generators, except personal shields"
restricted_units_data_SHIELD_LAND="No Land Shields"
restricted_units_info_SHIELD_BASE="Prevents structures with shield generators"
restricted_units_data_SHIELD_BASE="No Shield Structures"
...
tooltipui0710="Teams Count"
tooltipui0711="How many teams should there be?"
tooltipui0712="Curated Maps"
tooltipui0713="Open a web page in your browser to view curated maps"
tooltipui0714="Income"
tooltipui0715="Balance"
tooltipui0716="By Ctrl+click request mass from this ally.\nBy Shift+click gives 25% mass to this ally."
tooltipui0717="By Ctrl+click request energy from this ally.\nBy Shift+click gives 25% energy to this ally."
tooltipui0718="By Ctrl+click request engineer from this ally.\nBy Shift+click gives selected units to this ally."
...
uvd_Range="Range: %d - %d"
uvd_Reload="Reload: %0.1f"
uvd_ArmorType="Armor Type: "
uvd_DamageTaken="(% of damage taken)"
uvd_Radius="Radius: %d"
uvd_StorageSlots="Storage Slots: %d"
uvd_DockingSlots="Docking Slots: %d"
uvd_BuildRate="Build Rate: %0.1f"
uvd_FireRate="Fire Rate: %0.1f"
uvd_UnitSize="Unit Size: %d"
...
at_Normal="Normal"
at_Light="Light"
at_Commander="Commander"
at_Structure="Structure"
at_Experimental="Experimental"
at_ExperimentalStructure="Experimental Structure"
at_ASF="ASF"
at_TMD="TMD"

an_Normal="Normal"
an_Overcharge="Overcharge"
an_Deathnuke="Deathnuke"
an_ExperimentalFootfall="Experimental Footfall"
an_FireBeetleExplosion="FireBeetle Explosion"
an_CzarBeam="Czar Beam"
an_OtheTacticalBomb="Ahwassa Bomb"
an_TacticalMissile="Tactical Missile"
...
dalk003_desc="Mobile Missile Anti-Air"
delk003_help="Shinaider!"
dalk003_name="Redeemer"
delk002_desc="Mobile Rapid-fire AA Cannon"
delk002_help="Mobile Rapid-fire AA Cannon"
DELK002_name="Cougar"
DRLK001_desc="Mobile Missile Anti-Air"
DRLK001_help="Mobile Missile Anti-Air"
DRLK001_name="Bouncer"
drlk005_desc="Crab Egg (Bouncer)"
drlk005_help="Crab Egg (Bouncer)"
dslk004_desc="Lightning Tank"
dslk004_help="Unstable Lightning Tank"
dslk004_name="Uyanah"
zsb9501_name="Hethiya"
zsb9502_name="Ia-iya"
zsb9503_name="Uosiya"
zsb9601_name="Hethiya"
zsb9602_name="Ia-iya"
zsb9603_name="Uosiya"
lobui_0719="%s"
lobui_0750="Rating"
...
lobui_0584="Sort by official or custom maps"
lobui_0585="AI Markers"
lobui_0586="Select maps with AI Markers"
lobui_0588="You were automatically removed from the lobby because you don\'t have the following mod(s):\n%s \nPlease, install the mod before you join the game lobby"
...
uiunitmanager_14="LOCAL MODS"
uiunitmanager_15="NO DEPENDENCY"
uiunitmanager_16="Filter Missing Dependency Mods"
uiunitmanager_17="Toggle visibility of mods that are missing dependency in above list of mods."
uiunitmanager_18="Filter Local Mods"
uiunitmanager_19="Toggle visibility of game mods that are missing by other players"
...
lobui_0776="Random (Revealed)"
lobui_0777="Spawn everyone in random locations which are labeled"
...
loadingtip_0035="Overcharge can deal up to 15,000 damage to a unit, requiring around 49k energy capacity"
loadingtip_0036="The Salem can not shoot backwards"
...
loadingtip_0042="To kill with a single overcharge, you need 1 energy storage for T1 units, up to 2 for T2, and up to 4 for T3"
